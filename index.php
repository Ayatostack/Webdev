      ...
      <div class="container-fluid" id="myContainer">
          <div class="row">
              <div class="col-md-6 col-md-offset-3">
                  <h1>Create your recipe today!</h1>
                  <p class="lead">Save Money! Save the Environment!</p>
                  <p class="bold">You can save your effort in planning recipe!
                  </p>
                  <!--Search Form-->
                  <form class="form-inline" method="get" id="searchform">
                      <div class="form-group">
                          <label class="sr-only" for="departure">Search recipe:</label>
                          <input type="text" class="form-control" id="searchrecipe" placeholder="searchrecipe" name="searchrecipe">
                      </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 id="myModalLabel">
                    Sign up today and Start using our Recipe Sharing App! 
                  </h4>
              </div>
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label for="moreinformation">Comments (Optional): </label>
